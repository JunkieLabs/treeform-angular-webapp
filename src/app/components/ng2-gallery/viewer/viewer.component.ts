...
export class ViewerComponent {
    ...
    private updateQuality(): void {
        ...
        // console.log("quality",this.qualitySelected);
    ...
    public getImage(img,index){
        return img['viewerImageLoaded'] ? "url('"+img[this.categorySelected]['path']+"')" : Math.abs(this.currentIdx-index) <=1 ? "url('+img['preview_xxs']['path']+')" : ""
     }
}
